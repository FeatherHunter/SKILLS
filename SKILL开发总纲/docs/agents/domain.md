...
2. `SKILL开发总纲V1.0/CONTEXT.md` — 本技能的术语表与领域概念定义
3. `SKILL开发总纲V1.0/docs/adr/`（若有）— 本技能专属决策
...
每个 issue 标题必须以 `[SKILL开发总纲V1.0]` 开头，并携带 `skill:SKILL开发总纲V1.0` label；跨技能协调类建议同时携带 `cross-skill` label。