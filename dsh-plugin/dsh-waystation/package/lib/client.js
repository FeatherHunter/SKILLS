  ...
  factory: (require) => {
    ...
    exports.apply = function (ctx) {
      ...
      const PROMPTS = {
        ...
        "tpl.diagnose": { version: 1, placeholders: ['url'], use: '动作按钮「诊断」（needs-triage 票）', zh: '/triage\n{url}\n\n请诊断该 issue 并分流建议：\n1. 复现 / 现象 / 影响范围\n2. 根因推断（多个候选）\n3. 分流建议（修复 / 关闭 / 重设计 / 等）\n\n从第一性原理出发完成任务，并对抗式审查。', en: '/triage\n{url}\n\nDiagnose this issue and propose triage:\n1. Reproduction / symptom / impact\n2. Root-cause candidates\n3. Triage suggestion (fix / close / redesign / wait)\n\nApproach tasks from first principles, and review adversarially.' },
        "tpl.fix": { version: 1, placeholders: ['url'], use: '动作按钮「修复」（bug 票）', zh: '/wayfinder\n{url}\n\n请修复该 bug：\n1. 先复现\n2. 定位根因\n3. 实施修复\n4. 加测试\n5. 对抗式审查\n\n从第一性原理出发完成任务，并对抗式审查。', en: '/wayfinder\n{url}\n\nFix this bug:\n1. Reproduce first\n2. Find the root cause\n3. Implement the fix\n4. Add tests\n5. Adversarial review\n\nApproach tasks from first principles, and review adversarially.' },
        "tpl.discuss": { version: 1, placeholders: ['url'], use: '动作按钮「讨论」（grilling 票）', zh: '/wayfinder\n{url}\n\n请与我就该 issue 进行讨论（grill）：\n1. 目标 / 边界\n2. 风险 / 假设\n3. 选项 / 权衡\n4. 决策\n\n从第一性原理出发完成任务，并对抗式审查。', en: '/wayfinder\n{url}\n\nDiscuss this issue with me (grill):\n1. Goal / boundary\n2. Risks / assumptions\n3. Options / tradeoffs\n4. Decision\n\nApproach tasks from first principles, and review adversarially.' },
        "tpl.execute": { version: 1, placeholders: ['url'], use: '动作按钮「执行」（普通票）', zh: '{url}\n\n请执行该 issue：\n1. 读 Description / Notes / 阻塞关系\n2. 制定方案\n3. 实施\n4. 验收\n\n从第一性原理出发完成任务，并对抗式审查。', en: '{url}\n\nExecute this issue:\n1. Read Description / Notes / blocking relationships\n2. Plan\n3. Implement\n4. Verify\n\nApproach tasks from first principles, and review adversarially.' },
        ...
        "setup": { version: 1, placeholders: [], use: '环境检查横幅 · setup 未执行按钮', zh: '/setup-matt-pocock-skills\n（请选择 GitHub Issues 作为 issue tracker）', en: '/setup-matt-pocock-skills\n(choose GitHub Issues as the issue tracker)' },
        "newWayfinder": { version: 1, placeholders: ['repo'], use: '「+ 新建需求」按钮', zh: '/wayfinder\n请帮我（新增 / 复用 / 直接实现）一个需求：\n仓库：{repo}\n需求描述：', en: '/wayfinder\nPlease help me (add / reuse / directly implement) a requirement:\nRepo: {repo}\nRequirement: ' },
