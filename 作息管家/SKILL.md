...
description: >
  ...
  HELP 命中后 invoke `scripts/help_render.py`,输出 `$SKILLS_DB_PATH/schedule_html/help/help_center_<YYYYMMDD>_<HHMMSS>.html`(作息管家 `_naming_path` 命名规范)。
...
|---|---|---|---|
| "作息管家 HELP / 帮助 / 能做什么 / 使用说明" | (HELP 唤醒词,§07 契约) | `python scripts/help_render.py` | `$SKILLS_DB_PATH/schedule_html/help/help_center_<YYYYMMDD>_<HHMMSS>.html` |
