...
window.charts={
   ...
   * items:[{label,value,color?}] value 可 null（断线）· opt 全参数（见清单 16 项 + avgLine/legend/highlightLast/markLine/markPoint/series + connectNulls 跨缺失连线 + yTicks 轴刻度 v1.15 · #333） */
