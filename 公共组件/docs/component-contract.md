...
> 来源：v1.3（#288 图表组件落地）+ v1.4（#290 状态层加固）+ v1.5（#289 HELP 参数化）+ **v1.6 图表全参数化**（2026-08-12：方向 A 定稿，四形态全参数 + 复合形态）+ **v1.9 selectList 行内控件**（2026-08-13 · #327）+ **v1.10 copyText 反馈钩子**（2026-08-13 · #328）+ **v1.11 smartSelect 选择器组件**（2026-08-13 · #312 · 立项 #320）+ **v1.12 smartSelect 候选区折叠**（2026-08-13 · #312 实测反馈）+ **v1.13 line 动画断线修复**（2026-08-14 · #317 验收二轮）+ **v1.14 charts.line connectNulls**（2026-08-14 · #356）+ **v1.15 charts.line yTicks 轴刻度**（2026-08-14 · #333）+ **v1.16 markLine 标签拉伸/遮挡修复**（2026-08-14 · #333 验收）+ **v1.17 series[].ownScale 系列独立刻度**（2026-08-14 · #334）+ **v1.18 markPoint 峰谷点标注**（2026-08-14 · #319）+ **v1.19 band 置信带**（2026-08-14 · #335）+ **v1.20 markLine 竖线 xValue**（2026-08-14 · #340）+ **v1.21 fillBetween 线间填充**（2026-08-14 · #338）+ **v1.22 小缺口：异常点/拐点圈选/首尾标签避让**（2026-08-14 · #341）+ **v1.23 bar 堆叠柱 stacked**（2026-08-14 · #336）+ **v1.24 bar 分组双柱 grouped**（2026-08-14 · #339）
