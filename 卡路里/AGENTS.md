...
**已确认分类**(2026-08-01):主页 9 / 饮食 68 / 体重 58 / 运动 39 / 健身计划 29 / 目标管理 25 / 基础信息 4 / 身体细节 13 / 身材照片 10 / 技能协同 37(合计 292)。
**未确认分类**:分析。

**数字口径**(回答"有多少场景"时必须区分):
- **总数待全部分类定稿后统一核算**(2026-08-01 原则:分类未讨论完前不维护合计数字)
- 已确认数 292(10 分类含技能协同 37)/ 已落盘 JSON 34(主页 9 + 目标管理 25)
