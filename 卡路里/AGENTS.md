...
**已确认分类**(2026-08-01):主页 9 / 饮食 68 / 体重 58 / 运动 39 / 健身计划 29 / 基础信息 4(合计 207)。
**未确认分类**:目标管理(已落盘 JSON 待同步)/ 身体细节 / 身材照片 / 分析 / 技能协同。

**数字口径**(回答"有多少场景"时必须区分):
- 声称数 ~512(恢复文档表格) / 已确认数 207 / 已落盘 JSON 37(主页 9 + 目标管理 28 有重叠)
