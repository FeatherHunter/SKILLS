...
| `templates/crud_receipt.html` | 删吃的 / 改吃的 / 改食品 / 存食品 / 改体重记录 / 改运动记录 / 改照片标签 / 删身材照 / 设置档案 / 设活动量 / 改档案 | 各 CRUD 函数返回 diff | `scripts/render_crud_receipt.py [--live-profile-set/--live-profile-activity/--live-profile-update]` |
