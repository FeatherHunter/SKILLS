...
<!-- 遵守 V1.0 原则 12 · 跨 Skill HTML 输出约定(v2.4.18b 起,卡路里_HELP 加 `<skill 中文名>` 前缀对齐原则 12.1) -->
...
###### 设置档案(已实现 · render_profile_setup.py,配置型)

> 用户填好参数 → 点"生成 prompt" → 复制给 AI → AI 执行 `calorie_tracker.py profile set ...`

| 用户说法 | 触发方式 |
|---|---|
| `设置档案` | 打开 HTML,填年龄/性别/身高/备注 → 生成 prompt |
| `设置档案 30 male 177` | AI 解析后直接调 CLI,无需 HTML |
