...
> **当前版本:1.1.5**(2026-07-28 发布 · git tag `v1.1.5`)
...
**唤醒词**:记备忘、搜备忘、查备忘、改备忘、删备忘、看备忘、按时间搜备忘、备忘改分类、备忘改子分类、记提醒、设提醒、看提醒、查已提醒备忘、完成心愿(**别名:完成打卡 · 2026-07-24 加**)、心愿排期、备忘录同步、**备忘录 HELP**(v1.1.4 加 · 总纲 §07 契约)
