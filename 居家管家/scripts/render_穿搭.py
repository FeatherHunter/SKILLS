# render_穿搭.py - SM3 域渲染助手(08-HTML 交互规范 v1 · 镜像 render_物品.py 模式)
...
def emit_error(wake_word, command_cn, reason, key_data=None, suggest=None,
    ...
    result = render_page("穿搭/error.html", envelope, output_path, f"{command_cn}失败")
    print(json.dumps(result, ensure_ascii=False))
