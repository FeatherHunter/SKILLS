...
```bash
# 帧级剪切
python scripts/video/trim.py trim --input v.mp4 --start 30 --t 20 --output out.mp4

# 拼接(concat demuxer)
python scripts/video/trim.py concat --list clips.txt --output joined.mp4
```
