...
> **对应脚本**: `scripts/video/fx.py` + `scripts/video/keyframe.py`
...
```bash
# 慢动作 / 推镜头 / 模糊等
python scripts/video/fx.py --input v.mp4 --effect zoom_in --output out.mp4

# 关键帧动画
python scripts/video/keyframe.py --input v.mp4 --keyframes "0,1.0;2,1.5" --output out.mp4
```
