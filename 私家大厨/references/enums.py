...
"""食材分类 v5.2(ingredients.category) · 11 类 · 替代原 9 类
见 references/categories.md 边界规则:
  - 整株鲜香草 → 香草
  - 干粉末香草 → 调料
  - 主料地位(10g+)葱姜蒜 → 葱姜蒜;葱花/姜末 → 葱姜蒜
  - 洋葱/西红柿 → 蔬菜
"""
...
ALIASES = {
    ...
    "ingredient_categories": {
        # 葱姜蒜(用户口语别名 → 标准)
        "葱": "葱姜蒜", "小葱": "葱姜蒜", "香葱": "葱姜蒜", "大葱": "葱姜蒜",
        "姜": "葱姜蒜", "生姜": "葱姜蒜", "老姜": "葱姜蒜",
        "蒜": "葱姜蒜", "大蒜": "葱姜蒜", "蒜瓣": "葱姜蒜", "蒜苗": "葱姜蒜",
        "葱花": "葱姜蒜", "姜末": "葱姜蒜", "蒜末": "葱姜蒜", "蒜蓉": "葱姜蒜",
        # 香草(整株鲜香草 → 香草;干粉末 → 调料,见 validators)
        "迷迭香": "香草", "百里香": "香草", "罗勒": "香草", "九层塔": "香草",
        "欧芹": "香草", "莳萝": "香草", "鼠尾草": "香草", "薄荷": "香草",
        # 常见误归类纠正
        "洋葱": "蔬菜",  # 不是葱蒜
        "西红柿": "蔬菜",
        "番茄": "蔬菜",
